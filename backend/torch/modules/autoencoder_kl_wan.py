...
from backend.torch.layers.vae import DiagonalGaussianDistribution
...
class AutoencoderKLWan(nn.Module):
    ...
    def _decode(self, z: torch.Tensor) -> Union[torch.Tensor]:
        self.clear_cache()
    ...
    def decode(self, z: torch.Tensor) -> Union[torch.Tensor]:
        r"""
