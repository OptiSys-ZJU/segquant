...
from backend.torch.layers.embeddings import PixArtAlphaTextProjection, TimestepEmbedding, Timesteps, get_1d_rotary_pos_embed
from backend.torch.layers.normalization import FP32LayerNorm
    ...
    def from_config(cls, config_path, weight_path, weight_index_path):
        with open(config_path, "r", encoding="utf-8") as f:
            ...
            for name in model_state_dict:
                model_state_dict[name].copy_(
                    weights[weight_config["weight_map"][name]][name]
                )
