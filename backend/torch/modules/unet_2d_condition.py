...
from backend.torch.layers.unet import (
    get_down_block,
    get_mid_block,
    get_up_block,
)
    ...
    def from_config(cls, config_path, weight_path):
        with open(config_path, "r", encoding="utf-8") as f:
            ...
            model = cls(
                ...
                resnet_skip_time_act=config["resnet_skip_time_act"],
                resnet_out_scale_factor=config["resnet_out_scale_factor"],
                ...
                addition_embed_type_num_heads=config["addition_embed_type_num_heads"],
            )
