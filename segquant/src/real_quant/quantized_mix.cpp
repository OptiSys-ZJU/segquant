...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    // register_gemm_module<int8_t, cutlass::int4b_t>(m, "Wint8Aint4");
    // register_gemm_module<cutlass::int4b_t, cutlass::int4b_t>(m, "Wint4Aint4");
    // register_gemm_module<at::Half, cutlass::int4b_t>(m, "Wfp16Aint4");
    // register_gemm_module<at::Half, int8_t>(m, "Wfp16Aint8");
    // register_gemm_module<__nv_fp8_e4m3, __nv_fp8_e4m3>(m, "Wfp8e4m3Afp8e4m3");
    // register_gemm_module<at::Half, at::Half>(m, "Wfp16Afp16");
}