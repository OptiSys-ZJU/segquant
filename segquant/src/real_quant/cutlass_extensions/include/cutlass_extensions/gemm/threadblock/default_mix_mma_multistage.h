...
#include "cutlass_extensions/gemm/threadblock/mix_mma_multistage.h"
...
#include "cutlass_extensions/gemm/threadblock/default_mix_mma.h"
...
struct MixMma<ElementA, LayoutA, kAlignmentA, ElementB, LayoutB, kAlignmentB,
        ...
        ArchTag::kMinComputeCapability >= 80 && !layout::IsColumnMajorTileInterleave<LayoutB>::value)>::type>
{
    ...
    static_assert(platform::is_same<Operator, arch::OpMultiplyAddFp16Int4>::value,
        "Mma multistage must be OpMultiplyAddFp16Int4 after ldsm");

    static_assert(platform::is_same<ElementB, int4b_t>::value,
        "Element B must be uint8 or int4");
    ...
    using ThreadblockMma = cutlass::gemm::threadblock::MixMmaMultistage<typename MmaCore::Shape, IteratorA,
        ...
        ArchTag::kMinComputeCapability >= 80 && layout::IsColumnMajorTileInterleave<LayoutB>::value)>::type>
{
    ...
    using Operator = Operator_;
    static_assert(platform::is_same<Operator, arch::OpMultiplyAddFp16Int4>::value,
        "Mma multistage must OpMultiplyAddFp16Int4 after ldsm");
