...
#load_fake_quant_fp8_ext(verbose=False, required=True)
#load_real_quant_fp8_ext(verbose=False, required=True)
#load_real_quant_int8_ext(verbose=False, required=True)  # Most common for testing
#load_real_quant_int4_ext(verbose=False, required=True)