...
from stable_diff.model.controlnet_sd3 import SD3ControlNetModel, SD3MultiControlNetModel, AbstractSD3ControlNetModel
...
class StableDiffusion3ControlNetModel(nn.Module):
    r"""
    Args:
