...
def create_dataset(preprocessor, dataset, output_dir, cn_type='canny', enable_no_prompt=False):
    """
    ...
    for i, (k, v) in enumerate(tqdm(orig.items(), total=total_samples, desc="Processing samples"), 1):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="MJHQ-30K",
